<div>
    ...
    <h2 class="mb-2 text-center text-3xl font-medium">Welcome to the demo</h1>

    <div>
        <div class="flex flex-col w-full mt-8 -mx-2">
            <div class="flex flex-row">
                <div class="bg-white w-1/2 rounded-lg p-4 m-2 shadow-sm border-2 border-transparent text-gray-800">
                    <h2 class="mb-2 text-2xl text-black">A fully featured admin panel</h2>
                    <p>You can see a fully featured admin panel here. Resources with icons, relationships, computed fields, seeded data, and more.</p>
                </div>

                <div class="bg-white w-1/2 rounded-lg p-4 m-2 shadow-sm border-2 border-transparent text-gray-800">
                    <h2 class="mb-2 text-2xl text-black">Customized</h2>
                    <p>This admin panel showcases custom pages (the <em>Statistics</em>) page and custom actions (the <em>Create Order</em> page).</p>
                </div>
            </div>
            ...
            <div class="flex flex-row">
                ...
                <div class="bg-white w-1/2 rounded-lg p-4 m-2 shadow-sm border-2 border-transparent text-gray-800">
                    <h2 class="mb-2 text-2xl text-black">Auto-refreshing database</h2>
                    <p>The database refreshes every 5 minutes, so that you can play with the app without having to worry about messy data.</p>
                </div>
            </div>
        </div>
    </div>
